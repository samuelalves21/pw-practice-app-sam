...
test('checkboxes buttons', async({page}) => {
...
test('Web Tables', async ({page}) => {
    ...
    await page.locator('input-editor').getByPlaceholder('E-mail').fill('samuel@gmail.com')
    await page.locator('.nb-checkmark').click()
    await expect(targetRowByID.locator('td').nth(5)).toHaveText('samuel@gmail.com')
